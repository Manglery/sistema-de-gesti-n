  ...
  return (
    <SidebarProvider defaultOpen={true}>
      ...
      <SidebarInset className={cn("relative", className)}>
        ...
        <div className={cn("h-1.5 w-full fixed top-0 left-0 right-0 z-[60] transition-colors duration-500", accentColor)} />
        ...
        <div className="hidden md:flex absolute top-1.5 right-8 h-10 items-center gap-4 z-40">
          <div className="flex items-center gap-2 px-3 py-1 bg-white/90 backdrop-blur rounded-b-lg border-x border-b border-slate-200 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)]">
        ...
        <main className={cn(
          "min-h-screen flex flex-col pt-4",
