...
export function HomePage() {
  ...
  // Handle periodic refresh or manual context changes
  useEffect(() => {
    refetch();
  }, [selectedMonth, selectedYear, currentWarehouseId]); // refetch is stable to call despite ESLint warning
  return (
