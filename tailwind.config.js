  ...
  theme: {
  	extend: {
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px hsl(var(--brand) / 0.4)',
  			'glow-lg': '0 0 40px -10px hsl(var(--brand) / 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px hsl(var(--brand) / 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px hsl(var(--brand) / 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
  		...
  		backgroundImage: {
  			'gradient-rainbow': 'linear-gradient(135deg, hsl(var(--brand)) 0%, hsl(var(--brand-dark)) 25%, hsl(var(--brand-darker)) 50%, hsl(var(--brand-accent)) 100%)',
  			'gradient-primary': 'linear-gradient(135deg, hsl(var(--brand)), hsl(var(--brand-dark)))',
